...
@Component({
  selector: 'app-new-coach-incident',
  templateUrl: './new-coach-incident.component.html',
  styleUrls: ['./new-coach-incident.component.css']
})

export class NewCoachIncidentComponent implements OnInit {
  ...
  submitForm() {
    ...
    this.CoachService.IncidentReports.push(newIncident);
    this.CoachService.NewIncidents.push(newIncident);
